                    ...
                    <div className="p-12 experience-popup-container">
                        ...
                        <div>
                            ...
                            <div className="flex justify-center flex-col mt-4">
                                <h3 className="text-3xl font-semibold mb-3 tracking-tight experience-position-title">{data.title}</h3>
                                <p className="company-name-text text-lg font-medium">{data.company}</p>
                        ...
                        <div className="experience-information-container mt-8 p-6">
                            ...
                            <div className="exp-pos-exp-desc mt-4">{data.description}</div>
                        </div>
                        <div className="mt-8">
                            <div className="info-section-header font-semibold">SKILLS AND TECHSTACK</div>
                            <div className="flex flex-wrap gap-3 mt-4">
                                {data.techstack.map((tech, i) => (
                                    <div className="project-tech text-sm" key={i}>{tech}</div>
                                ))}
                            </div>
                        </div>

        ...
        <div>
            <div className="experience-card">
                <div className="exp-rounded-corners clickable-item" onClick={() => func(id)}>
                    <div className="experience-card-image" style={{backgroundImage: `url(${positionInfo.image})`}}></div>
                ...
                <div className="experience-card-text mt-3">
                    <h3 className="text-xl font-semibold tracking-tight">{positionInfo.title}</h3>
                    <div className="flex items-center gap-2 mt-1">
                        <p className="company-name-text font-medium">{positionInfo.company}</p>
